<template>
  <div class="quality-features bg-grey-lighten-3 py-15">
    <v-container fluid>
      <v-row>
...
export default {
  data: () => ({
    cards: [
      ...
      {
        title: " Fast Shipping ",
        description: "fast and Conveninet door to door delivery",
      ...
      },
      {
        ...
        description: " More than 10 different secure payment methoids",
